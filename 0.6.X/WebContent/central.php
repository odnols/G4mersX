...
<nav id="menu" class="navbar navbar-default navbar-fixed-top">
    ...
    <div class="navbar-header" id="navbar-header_central">
      	...
      	<a class="navbar-brand page-scroll" href="#page-top"><a class="navbar_brand navbar-right" href="#"><h5 class="tempo" id="tempo_">Agora são <em id="relogio"></em> de <em><?php echo "$date2" ?></em></h5></a></a>

    	<a class="page-scroll" href="#"><a class="navbar_brand" href="#perfil"><h5 class="perfil" id="tempo_">Perfil</h5></a>
  	</div>
...
<div id="espia_fundo_global">	
	...
	<form name="form_relogio" action="php_suporte/recebe_qtd.php" method="POST">
		<fieldset id="quadro_add">
			...
			<div id="dia_impt">
				...
				<h2 id="titulo">Dia Histórico!</h2><hr>
					<h4 id="historical">Note que hoje é um <br>dia Histórico, para poder editá-lo, vá para o mural <br><a href="#click_historico" style="color: white" class="page-scroll">>> Histórico <<</a><hr>
			...
			<?php }else{ ?>
				...
				<a id="dia_historico_click"><img id="estrela" src="img/icone/estrela.png"></a><hr>
	  ...
	  <?php if(!isset($hora_old)){
		...
		<div id="alinhadora"><hr id="loading_add"> <hr id="loading_add2">
	...
	<form action="php_suporte/recebe_atribuicao.php" method="POST">
		...
		<div id="alinhadora"><hr id="loading_add"><hr id="loading_add2"></div>
...
<div id="estatisticas">
	<h1 id="titulo">Navegando por Estatísticas</h1>
		...
		<div id="alinhadora2"><hr id="loading_add2"><hr id="loading_add">
    	...
    	echo "<a type='text' id='select_total' href='#' class='Input-text' maxlength='7' onclick='pegadata($total)'>Global</a>
    		  <br><br>";
    	?></div><div id="click_anual"></div> <?php
		}else{
...
<div id="click_historico">
	<h1 id="titulo"><img id="estrela" src="img/icone/estrela.png">Boas vindas ao Histórico!<img id="estrela" src="img/icone/estrela.png"></h1>
		<?php if($dias_historicos != 1 ){ ?>
			<em><h2>Atualmente existem <?php echo $dias_historicos; ?> dias históricos no sistema</h2></em>
		<?php }else{ ?>
