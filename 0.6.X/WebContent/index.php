...
<nav id="menu" class="navbar navbar-default navbar-fixed-top">
    ...
    <div class="navbar-header">    
      <a href="" class="btn btn-custom btn-lg page-scroll" id="gmx">G4mers_X</a></div>
...
<div class="loga"><br><br>
  ...
  <form name="loga" class="Logah" action="php_suporte/confirma_login.php" method="post">
    <h1 id="titulo">Login</h1>
      ...
      <button class="btn btn-custom btn-lg page-scroll" id="configura_perfil">Entrar</button><hr id="hr_log">
  </form>
  ...
  <form name="cadastro" class="cadastrah" action="php_suporte/recebe_cadastro.php" method="post">
    <h1 id="titulo">Cadastro</h1>
      ...
      <button class="btn btn-custom btn-lg page-scroll" id="configura_perfil">Cadastrar</button><hr id="hr_log">
  </form>
