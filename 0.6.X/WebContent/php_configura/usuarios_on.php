...
<head>
	...
	<style type="text/css">
		...
		@keyframes usuario{
			0% { opacity: 0; box-shadow: inset 0px 0px 0px white; border: 10px solid black; }
			50% { opacity: 1; box-shadow: inset 0px 0px 300px white; border: 0px solid grey;}
			100% { box-shadow: inset 0px 0px 0px white; border: 2px solid white;}
		}
		#nome_usuario_on{
			color: white;
			position: absolute;
